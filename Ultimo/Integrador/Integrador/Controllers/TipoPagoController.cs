...
namespace Integrador.Controllers
{
    public class TipoPagoController : Controller
    {
        ...
        public TipoPagoController(SportQuitoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.TipoPagos != null ? 
                          ...
                          Problem("Entity set 'SportQuitoContext.TipoPagos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SportQuitoContext.TipoPagos'  is null.");
            }
            var tipoPago = await _context.TipoPagos.FindAsync(id);
            if (tipoPago != null)
            {
