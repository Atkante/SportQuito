...
namespace Integrador.Controllers
{
    public class PerfilController : Controller
    {
        ...
        public PerfilController(SportQuitoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Perfils != null ? 
                          ...
                          Problem("Entity set 'SportQuitoContext.Perfils'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPerfil,TipoPerfil")] Perfil perfil)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPerfil,TipoPerfil")] Perfil perfil)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SportQuitoContext.Perfils'  is null.");
            }
            var perfil = await _context.Perfils.FindAsync(id);
            if (perfil != null)
            {
